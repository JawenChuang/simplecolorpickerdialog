...
public class ColorPreference extends Preference implements ColorPickerDialogListener {
    ...
    @SimpleColorPickerDialog.DialogType
    ...
    private void init(AttributeSet attrs) {
        ...
        dialogType = a.getInt(R.styleable.ColorPreference_cpv_dialogType, SimpleColorPickerDialog.TYPE_PRESETS);
        ...
        if (presetsResId != 0) {
            ...
            presets = SimpleColorPickerDialog.MATERIAL_COLORS;
        }
    ...
    protected void onClick() {
        ...
        if (onShowDialogListener != null) {
            ...
            SimpleColorPickerDialog dialog = SimpleColorPickerDialog.newBuilder()
    ...
    protected void onAttachedToActivity() {
        ...
        if (showDialog) {
            Activity activity = (Activity) getContext();
            SimpleColorPickerDialog fragment =
                    (SimpleColorPickerDialog) activity.getFragmentManager().findFragmentByTag(getFragmentTag());
            if (fragment != null) {
    ...
    /**
     * Set the colors shown in the {@link SimpleColorPickerDialog}.
     *
    ...
    /**
     * Get the colors that will be shown in the {@link SimpleColorPickerDialog}.
     *
    ...
    /**
     * The listener used for showing the {@link SimpleColorPickerDialog}.
    ...
    /**
     * The tag used for the {@link SimpleColorPickerDialog}.
     *
     * @return The tag
     */
