 ...
 * <p>
 * <pre>
 *   SimpleColorPickerDialog.newBuilder().show(activity);
 * </pre>
 */
public class SimpleColorPickerDialog extends DialogFragment implements OnTouchListener, ColorPickerView.OnColorChangedListener, TextWatcher {
    ...
    /**
     * Create a new Builder for creating a {@link SimpleColorPickerDialog} instance
     *
     * @return The {@link Builder builder} to create the {@link SimpleColorPickerDialog}.
     */
            ...
            colorPanelView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (v.getTag() instanceof Boolean && (Boolean) v.getTag()) {
                        colorPickerDialogListener.onColorSelected(dialogId, SimpleColorPickerDialog.this.color);
                        dismiss();
                        return; // already selected
                    }
                    SimpleColorPickerDialog.this.color = colorPanelView.getColor();
                    adapter.selectNone();
                    for (int i = 0; i < shadesLayout.getChildCount(); i++) {
                        FrameLayout layout = (FrameLayout) shadesLayout.getChildAt(i);
    ...
    public static final class Builder {
         ...
         *
         * @param dialogType Either {@link SimpleColorPickerDialog#TYPE_CUSTOM} or {@link SimpleColorPickerDialog#TYPE_PRESETS}.
         * @return This builder object for chaining method calls
         */
        ...
        /**
         * Create the {@link SimpleColorPickerDialog} instance.
         *
         * @return A new {@link SimpleColorPickerDialog}.
         * @see #show(Activity)
         */
        public SimpleColorPickerDialog create() {
            SimpleColorPickerDialog dialog = new SimpleColorPickerDialog();
        ...
        /**
         * Create and show the {@link SimpleColorPickerDialog} created with this builder.
         *
